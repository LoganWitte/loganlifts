    ...
    return(
        <div className="w-full max-w-screen h-fit bg-orange-500 border-b-1 border-black text-white flex items-center justify-between">
            ...
            <div className="flex text-sm sm:text-md md:text-xl text-center overflow-x-auto">
                <Link href="/calculator" className="p-2 my-2 mx-2 md:mx-4 hover:scale-105 hover:shadow-2xl transition duration-300 rounded-md bg-[#00000080] flex flex-nowrap items-center">
                    1RM Calculator
                ...
                <Link href="" className="p-2 my-2 mx-2 md:mx-4 hover:scale-105 hover:shadow-2xl transition duration-300 rounded-md bg-[#00000080] flex flex-nowrap items-center">
                    Nutrition Tracker
